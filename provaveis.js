                ...
                <div id="match-card-${idx}" class="bg-white rounded-[40px] border border-slate-100 p-2.5 md:p-4 shadow-sm hover:shadow-xl transition-all">
                    ...
                    <div class="flex items-center justify-between mb-4 gap-2">
                        ...
                        <div class="flex items-center gap-2 flex-1 justify-end">
                            <span class="font-jersey text-2xl md:text-3xl text-slate-400">${parseInt(match.clube_casa_posicao)}</span>
                        ...
                        <div class="flex items-center gap-2 flex-1">
                            ...
                            <span class="font-jersey text-2xl md:text-3xl text-slate-400">${parseInt(match.clube_visitante_posicao)}</span>
                        </div>
                    </div>
